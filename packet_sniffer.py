...
def get_traffic_stats():
    """Return the traffic statistics, converting deques to lists for JSON serialization."""
    global _traffic_stats
    # Create a copy to avoid modifying the original during iteration
    stats_copy = _traffic_stats.copy()  
    stats_copy["bytes_per_second"] = list(stats_copy["bytes_per_second"])
    stats_copy["packets_per_second"] = list(stats_copy["packets_per_second"])
    return stats_copy
